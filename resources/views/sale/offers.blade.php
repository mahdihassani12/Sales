                        ...
                        <div class="row">
						  <div class="col-md-4">
						    <div class="form-group">
							  <input type="text" class="form-control" name="product" id="product_name" placeholder="{{trans('file.barcode_or_name')}}" style="background:#efefef; font-family:Cairo;font-size:22px; padding:0px 10px 0px">
							</div>
						  </div>
...
<div class="sidebar" id="offer">
   ...
   <ul style="margin-top:70px" >
     <li id="view_all"> <span class="icon ion-ios-settings"> </span> {{trans('file.view_all')}} <b style="background:orange;padding:4px 7px;float:right;margin-top:5px;margin-right:5px;">{{$totalProdcut}}</b></li>
     <li id="promotion_item"> <span class="icon-list"> </span> {{trans('file.promotion_item')}} <b style="background:orange;padding:4px 7px;float:right;margin-top:5px;margin-right:5px;">{{$promotionProducts}}</b></li> 
	 <p style="font-size:22px; text-transform: uppercase;margin-bottom:0px;">{{trans('file.categories')}}</p>
	  ...
	  ?>	  
	 <li product_id="{{$category->id}}" class="category_item"> <span class="icon ion-ios-cart-outline"> </span> {{$category->name}} <b style="background:orange;padding:4px 7px;float:right;margin-top:5px;margin-right:5px;">{{$productPerCategory}}</b></li>
     @endforeach
   </ul>
</div>				
	  ...
	  @foreach($ezpos_product_list as $product)
	   ...
	   <div class="row" style="margin-top:10px;margin-bottom:10px;;padding-top:5px;padding-bottom:5px; background:#fff; background:2px 2px 12px #b1adad;">
		 <div class="col-md-2" style="border-right:1px solid #c5c4c4;">
		   <img src="{{url('public/images/product',$product->image)}}" style="width:140px;height:96px;object-fit: cover;">
		   <p> <input type="checkbox" name="is_finished" product_id="{{$product->id}}"> {{trans('file.allow_user_zero_balance')}}</p>
		 </div>
		 <div class="col-md-8" >
				    ...
				    <div class="row" style="font-weight:bold;color:#a7a6a6">
					  <div class="col-md-6">
					    <div class="row" style="margin:0px">
						 <div class="col-md-6">
						  {{trans('file.total_item')}}:   <span id="span-right" style="margin-left:24px;color:#000">0</span>
						 </div>
                         <div class="col-md-6">						 
						   {{trans('file.total_money')}}:  <span id="span-left" style="margin-left:24px;color:#000">0</span>
						 </div>  
						</div>
						<div class="row" style="margin:0px; margin-top:13px">
						   <div class="col-md-5">
						  {{trans('file.payment_method')}}: 
						 </div>
                         <div class="col-md-7">						 					 
						   <button class="btn" style="width:88px">{{trans('file.debit')}}</button>
						   <button class="btn" style="width:88px;background:#fff;border:1px solid gray;" >{{trans('file.cash')}}</button>
						 </div> 
						</div>
					  </div>
					  <div class="col-md-3">
					     <div> {{trans('file.discount')}}  <input type="number" value="0" id="jdiscount" name="jdiscount" style="width: 133px;float: right;font-weight:bold"></div>
					     <div style="clear: both;margin-top: 10px;">{{trans('file.net')}}  <input type="text" readonly name="net" id="net" style="font-weight:bold;width:133px; float:right"></div>
					  </div>
					  <div class="col-md-3">
					    <button class="btn btn-lg " style="background:#6d6b6b;color:#fff;padding:15px;"  id="draft-btn">{{trans('file.save_draft')}}</button>
					    <button class="btn btn-lg cash" style="background:linear-gradient(to right,#EE8636,#E03C8E);color:#fff;width:100px;padding:15px;" data-toggle="modal" data-target="#add-payment" id="cash-btn">{{trans('file.save')}}</button>
					  </div>
					</div>
				  </div>
			   </div>	
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-7" >
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['url' => 'sale/storeoffer', 'method' => 'post', 'files' => true, 'class' => 'payment-form']) !!}
                        @php
