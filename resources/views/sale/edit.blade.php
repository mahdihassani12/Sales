            ...
            <div class="col-md-5 cart_section" style="margin-top:-74px;">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
							    <div class="row cart_header_details"   style="display:none">
								  <div class="col-sm-12">
									<h1><span class="total_net">{{trans('file.net_total')}}</span><span class="jtotal" id="grand-total">{{number_format((float)($ezpos_sale_data->grand_total), 2, '.', '')}} <span class="fa fa-money" id="jcash_icon"></span></span></h1>
								  </div>
								</div>
								   ...
								   <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <?php $isRequested=DB::table('sales')->where('id',$currenctSalesId)->get()[0]->request_id; ?>
                                                     @if($isRequested !="")
														  <h4> {{trans('file.online')}} {{trans('file.request')}}</h4>
													      <h4>
														  {{trans('file.customer')}} {{trans('file.name')}}: <?php echo DB::table('request')->where('id',$isRequested)->get()[0]->customer_name; ?>
														 </h4>
			...
			<!--category list -->			   
               <div class="card category_cart" style=" width:61% !important; margin-right: -32px !important;">
			     <div class="card-body">
                    ...
                    @endforeach
					          <li id="view_all_item"><a href="#" >{{trans('file.view_all')}}</a></li>
				   </ul>	
				 </div>
               </div> 			   
