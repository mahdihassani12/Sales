...
<div role="document" class="modal-dialog">
  <div class="modal-content">
  	{!! Form::open(['route' => 'store.newstore', 'method' => 'post']) !!}
    <div class="modal-header">
      <h5 id="exampleModalLabel" class="modal-title">{{trans('file.add')}} {{trans('file.Store')}}</h5>
      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
    </div>
    <div class="modal-body row">
      <p class="italic col-md-12"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
        <div class="form-group col-md-6">
         ...
         <div class="form-group col-md-6" style="display:none">
          <label><strong>{{trans('file.store_category')}} *</strong></label>
          <select name="store_category_id[]" class="form-control selectpicker"  data-live-search="true" data-live-search-style="begins" title="Select Category..."  multiple="multiple">
            @foreach($ezpos_store_category_all as $ct)
        ...
        <div class="form-group col-md-6">
		  ...
		  <select name="branch" class="form-control selectpicker"  data-live-search="true" data-live-search-style="begins" title="Select Branch...">
