            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['qty_adjustment.insertNew', $ezpos_adjustment_data->id], 'method' => 'post', 'files' => true]) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
	        ...
	        $.ajax({
	            ...
	            success: function(data) {
	                ...
	                if(flag){
						...
						if(typeAd=="out_store"){
	                     cols += '<td class="action" style="display:none"><select name="action[]" class="form-control act-val"><option value="-" selected>{{trans("file.Subtraction")}}</option><option value="+" >{{trans("file.Addition")}}</option></select></td>';
	                    }
						else{
	                     cols += '<td class="action" style="display:none"><select name="action[]" class="form-control act-val"><option value="+" selected>{{trans("file.Addition")}}</option><option value="-">{{trans("file.Subtraction")}}</option></select></td>';
						}
