            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.add_product_quick')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['url' => '', 'method' => 'post', 'files' => true, 'id' => 'add_product_form']) !!}
                        <div class="row">
						  <div class="col-md-3">
						    <div class="form-group">
							  <label for="product_name"><strong>{{trans('file.product')}} {{trans('file.name')}} *</strong></label>
						  ...
						  <div class="col-md-3">
						    <div class="input-group">
							  <label for="barcode" style="width:100%"><strong>{{trans('file.Code')}}</strong> </label>
							  <input type="text"  name="barcode" class="form-control" id="barcode"><div class="input-group-append"><button id="genbutton" type="button" class="btn btn-default">{{trans('file.Generate')}}</button></div>
							</div>
						  </div>
						  
						  <div class="col-md-3">
						    <div class="form-group">
                                    <label for="category_id"><strong>{{trans('file.category')}} </strong> </label>
                                    <div class="input-group">
						  ...
						  <div class="col-md-3">
						     <div class="form-group">
							     <label for="file"><strong>{{trans('file.Attach File')}} </strong> </label>
						  ...
						  <div class="col-md-3" style="display:none">
						       <div class="form-group">
                                 <label for="cost"><strong>{{trans('file.product')}} {{trans('file.Cost')}} </strong> </label>
                                 <input type="number" name="cost" id="cost"  class="form-control" step="any" value="1">
                                </div>
						  </div>
						  
						  <div class="col-md-3" style="display:none">
						    <div class="form-group">
                              <label for="price"><strong>{{trans('file.product')}} {{trans('file.Price')}} </strong> </label>
                              <input type="number" name="price" id="price" class="form-control" step="any" value="1">
                            </div>
						  </div>
						  
						  <div class="col-md-3">
						    <div class="form-group">
							  <label for="unit"><strong>{{trans('file.product')}} {{trans('file.Unit')}} </strong></label>
						   ...
						   <div class="col-md-3">
						    <div class="form-group">
							  <label for="quantity"><strong>{{trans('file.Quantity')}} </strong></label>
						  ...
						  <div class="col-md-3">
						    <div class="form-group">
							  <label for="alert_quantity"><strong>{{trans('file.Alert')}} {{trans('file.Quantity')}}</strong> </label>
                              <input type="number" name="alert_quantity" id="alert_quantity" class="form-control" step="any">
                                                   ...
                                                   <div class="col-md-6">
						    <div class="form-group">
							<label for="alert_quantity"><strong>{{trans('file.product')}} {{trans('file.Details')}}</strong> 
                                                                   </label>
						...
						<div class="form-group">
                            <input type="button" value="{{trans('file.submit')}}" class="btn btn-primary" id="sendformData">
                            <input type="button" value="{{trans('file.edit')}}" class="btn btn-success" id="editformData">
						...
						<h4>{{trans('file.lastest_inserted')}}</h4>
						<table class="table table-striped">
						   <thead>
						     <tr><th>#</th><th>{{trans('file.name')}}</th><th>{{trans('file.Code')}}</th><th>{{trans('file.category')}}</th><th>{{trans('file.Alert')}} {{trans('file.Quantity')}}</th><th>{{trans('file.Unit')}}</th><th>{{trans('file.price')}}</th></tr>
						   </thead>
