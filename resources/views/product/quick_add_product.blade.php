            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.quick_add_product')}}</h4>
                    </div>
                    <div class="card-body">
                      <div class="checkbox_labels">
                       ...
                       <div class="importtextarea col-md-6">
                    	  ...
                    	  <h2 class="total_rows">{{trans('file.total_row')}} <span>0</span></h2>
                    	  ...
                    	  <div class="input_fields_title row"> 
                           ...
                           <form method="get" action="{{asset('product/save_excel_data')}}">
							<div class="row">
							...
							<div class="save_form">
							<input type="submit" class="btn" name="" value="{{trans('file.save')}} +">
							</div>
						  </form>
