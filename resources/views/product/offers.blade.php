						  ...
						  <div class="col-md-4">
						    <div class="form-group">
							  <select class="form-control"> 
							    <option value="">{{trans('file.select_customer')}}</option>
						  ...
						  @foreach($products as $product)
						   <div class="row" style="margin-top:10px;margin-bottom:10px;;padding-top:5px;padding-bottom:5px; background:#fff; background:2px 2px 12px #b1adad;">
							 ...
							 <div class="col-md-2 add_to_cart" style="border-left:1px solid #c5c4c4;">
							   ...
							   <p><button class="btn btn-block add_cart" style="color:#fff; font-size:17px; background:linear-gradient(to right,#EE8636,#E03C8E)" product_id="{{$product->id}}">{{trans('file.add')}}</button></p>
				...
				<div class="card" style="margin:0px;">
				  <div class="card-body jshipping">
				    <div class="row" style="font-weight:bold;color:#a7a6a6">
					  ...
					  <div class="col-md-3">
					     <div> {{trans('file.discount')}}  <input type="number" value="0" id="discount" name="discount" style="width: 133px;float: right;font-weight:bold"></div>
					  ...
					  <div class="col-md-3">
					    <button class="btn btn-lg " style="background:#6d6b6b;color:#fff;width:100px;padding:15px;" >{{trans('file.save_draft')}}</button>
					    <button class="btn btn-lg cash" style="background:linear-gradient(to right,#EE8636,#E03C8E);color:#fff;width:100px;padding:15px;" data-toggle="modal" data-target="#payModal">{{trans('file.save')}}</button>
					  </div>
					</div>
				  </div>
			   </div>	
   ...
   <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
						  {!! Form::open(['url' => 'offers/sele', 'method' => 'post', 'files' => true, 'class' => 'payment-form']) !!}
                            <div class="">
