        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel" style="background:#1e2636">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}" style="color: #7c5cc4; font-size: 18px; font-weight: bold;">
                   <img src="{{asset('public/logo/logo-home.png')}}" style="width:100px;">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li><a class="nav-link" href="{{ route('login') }}" style="color: #ced9e0;">{{ __('Login') }}</a></li>
                            <li><a class="nav-link" href="{{ route('register') }}" style="color: #ced9e0;">{{ __('Register') }}</a></li>
                        @else
