        ...
        <table id="product-data-table" class="table table-striped rwd-table" data-autogen-headers="true">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.mail')}}</th>
                    <th>{{trans('file.phone')}}</th>
                    <th>{{trans('file.extra')}}1</th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
								...
								<li>
                                    <a href="{{ asset('company/edit')}}/{{$comp->company_id}}" class="btn btn-link"><i class="fa fa-edit"></i> {{trans('file.edit')}}</a>
                                </li>
								<li class="divider"></li>
								{{ Form::open(['url' => ['company/delete', $comp->company_id], 'method' => 'DELETE'] ) }}
                                <li>
