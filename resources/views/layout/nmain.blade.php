...
<script type="text/javascript" src="<?php echo asset('public/vendor/datatable/dataTables.checkboxes.min.js') ?>"></script>
  ...
  <body style="background:#f4f7fa">
	...
	.side-navbar li ul li a:hover, .side-navbar li ul li.active a{
	  ...
	  nav.mCustomScrollbar,.side-navbar li a:focus,.btn-primary,.page-item.active .page-link , .side-navbar li a:hover, .side-navbar li a[aria-expanded="true"], .side-navbar .sidenav-header{
		  background: #fff;<?php //echo $color->color;?>;
		  border-color:#fff;<?php //echo $color->color;?>;
	  }
	  .btn-primary, .btn-primary.active {
		 border:2px solid #fff;<?php //echo $color->color;?> !important ; 
	  }
	  .btn.btn-default, .btn.btn-default:focus{
		 border:1px solid <?php // echo $color->color;?> !important ; 
		 color: #707070; <?php //echo $color->color;?> !important ; 
	  }
	  .page-link{
		  color:#707070;<?php //echo $color->color;?>;
	  }
	  .side-navbar li ul li a:hover, .side-navbar li ul li.active a{
		  background:#fff;<?php //echo $color->color;?> !important;
		  opacity:0.8;
	  }
	...
	<header class="header" style="position:fixed; width:100%; z-index:33">
        <nav class="navbar" style="border:none">
          <div class="container-fluid">
            <div class="navbar-holder">
              <div class="row">
			    <div class="col-sm-10">
			      <span class="brand-big text-center">@if($general_setting->site_logo)<img src="{{url('public/logo', $general_setting->site_logo)}}" height="55" width="80" style="background:gray;margin-right:50px;margin-top:-7px">&nbsp;&nbsp;@endif</span>
			     <ul class="time_date">
				   <li class="date">التاریخ:  <span><?php echo date('Y-m-d');?></span></li>
				   <li class="time">الوقت:   <span><?php echo date('h:i:s');?></span> <span class="icon ion-calculator" style="font-size:37px;"></span></li>
			    </ul>
              </div>
			  ...
			  <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <li class="nav-item" >
                      <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="fa fa-power-off"></i>  
                          <span class="caret"></span>
                          <span class="sr-only">Toggle Dropdown</span>
                      </a>
					  
                      <ul class="dropdown-menu  dropdown-menu-right dropdown-default" user="menu">
      ...
      <!-- modal section -->
   <div class="width:100%;">
    <nav class="side-navbar" style="margin-top:88px;border-radius: 14px;height:560px;margin-right:15px;background:#fff;">
      <div class="side-navbar-wrapper">
        <!-- Sidebar Header    -->
		
          <div style="border-bottom: 1px solid #b9b7b7; padding:20px 14px;margin-bottom:10px;">
		     <div style="width:60px; height:60px;margin-left:9px;float:right; border-radius:50%;background:gray;">
			 </div>
			 <div style="text-align:right;margin-top:10px;">
			    <h3 style="color:gray;">مدیر</h3>
			    <p style="color:#b5b3b3;">مالک العمل</p>
			 </div>
			<h2 style="clear:both;color:#44cc44;text-align:right;font-size:13px;">تغییر کلمه السر
			 <span style="color:gray;float:left;">admin@gmail.com</span>
			</h2> 
		  </div>
		  <div style="text-align: center;border-bottom: 1px solid #b9b7b7;">
            <h2 style="color:#b5b3b3;font-size:19px;">رصید المال الفتتاحی</h2>
		    <p style="font-size:24px;margin-bottom:10px;color:#44cc44;font-weight:bold;">454345434</p>
		  </div> 
        ...
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="#product" aria-expanded="true" data-toggle="collapse"> <i class="icon-list"></i>{{__('file.product')}}</a>
			...
			<li><a href="{{asset('offers')}}"><i class="icon ion-ios-speedometer-outline"></i> {{trans('file.offers')}}</a></li>
			<li><a href="{{asset('offers1')}}"><i class="icon ion-ios-speedometer-outline"></i> {{trans('file.offers')}}1</a></li>
			<li><a href="#company" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i>{{__('file.company')}}</a>
			...
			<li><a href="#country" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i>{{__('file.country')}}</a>
            ...
            <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="icon-bill"></i>{{trans('file.Purchase')}}</a>
              <ul id="purchase" class="collapse list-unstyled ">
                <li><a href="{{route('purchase.index')}}">{{trans('file.Purchase')}} {{trans('file.List')}}</a></li>
                <?php 
                ...
                ?>
                @if($add_permission_active)
                <li><a href="{{route('purchase.create')}}">{{trans('file.add')}} {{trans('file.Purchase')}}</a></li>
                @endif
              </ul>
            </li>
            @endif
            ...
            <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-share"></i>{{trans('file.Transfer')}}</a>
              <ul id="transfer" class="collapse list-unstyled ">
                <li><a href="{{route('transfers.index')}}">Transfer List</a></li>
                <?php 
                ...
                ?>
                @if($add_permission_active)
                <li><a href="{{route('transfers.create')}}">{{trans('file.add')}} {{trans('file.Transfer')}}</a></li>
                @endif
              </ul>
            </li>
            @endif
            ...
            @endif
            <li><a href="#adjustment" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-settings"></i>{{trans('file.Quantity')}} {{trans('file.Adjustment')}}</a>
              <ul id="adjustment" class="collapse list-unstyled ">
                ...
                <li><a href="{{route('qty_adjustment.create')}}">{{trans('file.add')}} {{trans('file.Adjustment')}}</a></li>
              </ul>
            </li>
            ...
            <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-paper-outline"></i>{{trans('file.Report')}}s</a>
              <?php
...
<div class="page" style="margin-top:76px;margin-left:-15px;">  
