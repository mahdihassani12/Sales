      ...
      <header class="header pos_header">
        <nav class="navbar1">
		  ...
		  <div class="col-md-5">
		   ...
		   <div class="col-md-7">
            <div class="">
              <div class="navbar-header" style="display:none"><a href="{{url('/')}}" class="navbar-brand">
                <div class="brand-text d-none d-md-inline-block"><h3 style="display:none">{{trans('file.welcome')}} <span>{{Auth::user()->name}}</span> </h3></div></a></div>
                 <div class="row">
				 <div class="col-md-8"> 
					<div class="search-box form-group" >
					  <div class='header_search_bar' style='position:relative;'>
					    <input type="text" name="product_code_name" id="ezpos_productcodeSearch" placeholder="{{trans('file.search_product')}}" class="form-control pos-text"  autofocus="autofocus"/>
			     ...
			     <div class="col-md-4">	 
				  <ul class="list-unstyled d-flex flex-md-row align-items-md-center" style="float:left; padding:0px">
					<li class="">
					  ...
					  <a class="home_page_link" href="{{url('/')}}" ><i class="fa fa-home"></i> </a>
					</li>
					<li class="nav-item"> 
					</li>
				  </ul>
