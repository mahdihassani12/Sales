...
class ExpenseCategoryController extends Controller
{
    ...
    {
        $ezpos_expense_category_all = ExpenseCategory::where('is_active', true)->get();
        return view('expense_category.index', compact('ezpos_expense_category_all'));
    }
    ...
    {
        $ezpos_expense_category_data = ExpenseCategory::find($id);
        return $ezpos_expense_category_data;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = $request->all();
        $ezpos_expense_category_data = ExpenseCategory::find($data['expense_category_id']);
        $ezpos_expense_category_data->update($data);
    ...
    {
        $ezpos_expense_category_data = ExpenseCategory::find($id);
        $ezpos_expense_category_data->is_active = false;
        $ezpos_expense_category_data->save();
