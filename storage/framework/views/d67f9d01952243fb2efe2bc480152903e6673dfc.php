    ...
    <div class="table-responsive">
        <table id="sale-table" class="table table-hover sale-list rwd-table" data-autogen-headers="true">
            <thead>
                ...
                <?php if((Auth::user()->role_id==12 and $sale->is_printed==0) or (Auth::user()->role_id!=12 )): ?> 

                <tr class="sale-link is_printed<?php echo e($sale->id); ?>" data-sale='["<?php echo e($date); ?>", "<?php echo e($sale->reference_no); ?>", "<?php echo e($sale_status); ?>", "<?php echo e($customerName); ?>", "<?php echo e($phone_number); ?>", "<?php echo e($customer_address); ?>", "<?php echo e($customer_city); ?>", "<?php echo e($sale->id); ?>", "<?php echo e($sale->total_tax); ?>", "<?php echo e($sale->total_discount); ?>", "<?php echo e($sale->total_price); ?>", "<?php echo e($sale->order_tax); ?>", "<?php echo e($sale->order_tax_rate); ?>", "<?php echo e($sale->order_discount); ?>", "<?php echo e($sale->shipping_cost); ?>", "<?php echo e($sale->grand_total); ?>", "<?php echo e($sale->paid_amount); ?>", "<?php echo e($sale->sale_note); ?>", "<?php echo e($sale->staff_note); ?>", "<?php if(isset($user->name)): ?><?php echo e($user->name); ?> <?php endif; ?>", "<?php echo e($user->email); ?>", "<?php if(isset($store->name)): ?><?php echo e($store->name); ?> <?php endif; ?>"]'  request_id="<?php echo e($sale->request_id); ?>"  <?php if($sale->is_printed==1): ?>  style="background: #e3ffb6;" <?php endif; ?>>
			 ...
			 <span style="width:10px; height:10px; background:#00c500;border-radius:50%"></span> 
			   ...
			   ?>
				 ...
				 <?php echo e($sale->total_qty); ?>
                    ...
                    <td><input type="checkbox" name="is_printed" class="is_printed" value="<?php echo e($sale->id); ?>" <?php if($sale->is_printed==1): ?> checked <?php endif; ?>></td>
                    <td >
