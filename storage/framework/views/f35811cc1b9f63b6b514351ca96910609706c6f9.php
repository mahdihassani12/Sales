...
<?php endif; ?>
	 ...
	 <div class="container-fluid" >
        ...
        <h2 style="margin-top: 12px;border-bottom: 1px solid lightgray;padding-bottom: 8px;">المحلات
          ...
          <a href="<?php echo e(asset('dashboard/store')); ?>/all" style="font-size: 15px;float:left;">عرض كل المخازن</a>
        </h2>

        <div class="row store_boxes">
         <?php $__currentLoopData = $data['store_cat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
           <div class="col-md-3">
          <a href="<?php echo e(asset('dashboard/store')); ?>/<?php echo e($st->id); ?>">
            <div class="store_box">
                <div class="first_section">
                    ...
                    <div class="col-12">
                       ...
                       <h3 class="store_category">&nbsp; <img src="<?php echo e(asset('public/images/icons/shopping-cart-black-shape.svg')); ?>"> &nbsp; <span style="font-size:22px"> <?php echo e($all_Orders_count); ?> </span> <span class="order-lable"> &nbsp; الطلبات الكلية </span></h3>
                    </div> 
                 </div>
             </div>
             </a>    
