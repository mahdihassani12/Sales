 ...
 <?php if($storeName=="single_store"): ?>
   ...
   <table class="table table-striped rwd-table" id="report-table" data-autogen-headers="true">
         ...
         <tbody>
		  ...
		  <tr><td></td><td><?php echo e($product_qty->name); ?></td><td><?php echo e($product_qty->arabic_name); ?></td><td><?php echo e($product_qty->code); ?></td><td><?php echo e($product_qty->qty); ?></td></tr>
