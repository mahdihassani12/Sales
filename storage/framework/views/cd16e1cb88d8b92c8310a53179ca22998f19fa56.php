                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select <?php if($user_role!=2 and $user_role!=1): ?> <?php echo e('disabled'); ?> <?php endif; ?> required id="store_id" name="store_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select store...">
                                                ...
                                                <option value="<?php echo e($store->id); ?>" <?php if($default_store==$store->id): ?> <?php echo e('selected'); ?> <?php endif; ?>> <?php echo e($store->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
											<input type="hidden" name="adjustment_type" value="out_store">
                                            <input type="hidden" id="user_default_store" value="<?php echo e($default_store); ?>" role_id="<?php echo e($user_role); ?>">

                                            <?php if($user_role!=2 and $user_role!=1): ?>
	        ...
	        $.ajax({
	            ...
	            success: function(data) {
	                ...
	                if(flag){
	                    ...
	                    cols += '<td>' + data[0] + '</td>';
	                    cols += '<td>' + data[1] + '</td>';
	                    cols += '<td><input type="number" class="form-control qty" name="qty[]" value="1" required max="6" /></td>';
	                    cols += '<td class="action"><select name="action[]" class="form-control act-val" style="display:none"><option value="-" selected><?php echo e(trans("file.Subtraction")); ?></option><option value="+" ><?php echo e(trans("file.Addition")); ?></option></select></td>';
