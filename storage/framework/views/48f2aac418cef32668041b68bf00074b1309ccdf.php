      ...
      <div class="modal-body">
         <div class="row">
		    <div class="col-md-6 description">
			   ...
			   <h2 class="selected_product_name arabic_name" style="display:none"><?php echo e($product->arabic_name); ?></h2>
			  ...
			  <div class="row">
			   ...
			   ?>
			    ...
			    <div class="col-md-3" style='padding-right:10px;'>
				  ...
				  <img style=" border:1px solid black" src="<?php if($product->external_link==1): ?> <?php echo e($product->image); ?> <?php else: ?> <?php echo e(asset('public/images/product')); ?>/<?php echo e($product->image); ?> <?php endif; ?>" variation_id="<?php echo e($product->id); ?>" variation_price="<?php echo e($product->price); ?>"  variation_name="<?php echo e($product->name); ?>" variation_qty="<?php echo e($allQuantity); ?>">
			      <?php $counter=1; ?>
				  <?php $__currentLoopData = $productImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				     ...
				     <img src=" <?php if($gl->external_link==0): ?><?php echo e(asset('public/images/product_variation')); ?>/<?php endif; ?><?php echo e($gl->imag_gallery); ?>1"  >  
                                    <?php $counter++;?>				 
