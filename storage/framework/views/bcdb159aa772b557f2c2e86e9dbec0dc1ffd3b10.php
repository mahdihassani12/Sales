            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.update')); ?> <?php echo e(trans('file.User')); ?> <?php echo e(trans('file.profile')); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><strong><?php echo e(trans('file.User')); ?> <?php echo e(trans('file.name')); ?> *</strong> </label>
                                    <input type="text" name="name" value="<?php echo e($ezpos_user_data->name); ?>" required class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="<?php echo e($ezpos_user_data->email); ?>" required class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" value="<?php echo e($ezpos_user_data->phone); ?>" required class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label><strong><?php echo e(trans('file.Company Name')); ?></strong> </label>
                                    <input type="text" name="company_name" value="<?php echo e($ezpos_user_data->company_name); ?>" class="form-control" />
                                </div>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $("ul#setting li").eq(7).addClass("active");
