     <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         ...
         <div class="row">
		    <div class="col-md-6 description">
			   <a href="#"><?php echo e($product->cateName); ?></a>
			    <h2 class="selected_product_name english_name" style="display:none"><?php echo e($product->name); ?></h2>
			    <h2 class="selected_product_name arabic_name" style=""><?php echo e($product->arabic_name); ?></h2>
		    ...
		    <div class="col-md-6 feature">
			  <div class="row">
			     <div class="col-md-9" style="padding-left:2px;padding-right:30px;">
			      <img style="width:100%;" src="<?php if($product->external_link==1): ?> <?php echo e($product->image); ?> <?php else: ?> <?php echo e(asset('public/images/product')); ?>/<?php echo e($product->image); ?> <?php endif; ?>" class="showBigPic">
			    </div>
				 <?php 
			   ...
			   ?>
			    ...
			    <div class="col-md-3" style='padding-right:10px;'>
				  ...
				  <img style=" border:1px solid black" src="<?php if($product->external_link==1): ?> <?php echo e($product->image); ?> <?php else: ?> <?php echo e(asset('public/images/product')); ?>/<?php echo e($product->image); ?> <?php endif; ?>" variation_id="<?php echo e($product->id); ?>" variation_price="<?php echo e($product->price); ?>"  variation_name="<?php echo e($product->name); ?>">
			      <?php $counter=1; ?>
				  <?php $__currentLoopData = $productImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				     <?php //$allQTY=DB::table('product_store')->where('product_id',$product->id)->sum('qty')?>		  
				     <img src=" <?php if($gl->external_link!=1): ?> <?php echo e(asset('public/images/product_variation')); ?>/<?php endif; ?><?php echo e($gl->imag_gallery); ?>"  >  
                                    <?php $counter++;?>				 
      ...
      <div class="modal-footer" style="position:relative">
        <span class="price selected_product_price" style="display:none"><?php if(strpos($product->price,'.')===false): ?> <?php echo e(number_format($product->price,0,'.',',')); ?> <?php else: ?><?php echo e(rtrim(number_format($product->price,2,'.',','),".0")); ?> <?php endif; ?></span>
	<input type="hidden" id="primary_selected_product_price" value="<?php echo e($product->price); ?>" category="<?php echo e($product->category_id); ?>">
        ...
        <button style="position:absolute;left:10px;"  class="btn add_to_cartd" product_id="<?php echo e($product->id); ?>" product_qty="<?php echo e($product->storeqty-$added_number); ?>">اطلب الان</button>
		<div class="add_to_cart_alert alert alert-success alert-dismissable" style="display:none;background:transparent; border:none;position:absolute;left:9px;bottom:-10px;">  
		  ...
		  <strong >تمت اضافة المنتج للسلة بنجاح</strong>
		   ...
		   <div class="product_videos" style="display:none">
		     <?php if($product->product_link!=null): ?> <a href="#product_video" data-toggle="modal" class="product_video" product_video="<?php echo e($product->product_link); ?>">Watch Video <b class="fa fa-eye"></b></a> <?php endif; ?>
		  </div>
