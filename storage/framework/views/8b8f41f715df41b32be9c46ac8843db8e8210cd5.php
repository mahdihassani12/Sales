<div class="row">
<h3 style="margin-bottom:10px;" class="col-md-9"><?php echo e($catename); ?> <span style="float:left; font-size:20px; color:#d0d0d0;"> عدد المنتجات  &nbsp;&nbsp;&nbsp;<?php echo e($productQTY); ?><span></h3>
  ...
  <div class="col-12">
  	...
  	<select class="form-control select_subCategory" style="border-radius: 6px;    box-shadow: 3px 5px 10px #ddd;font-size:19px ">
  		...
  		<?php $__currentLoopData = $childCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($chcat->id); ?>" <?php if($chcat->id==$id): ?> selected <?php endif; ?>><?php echo e($chcat->name); ?></option>
	  ...
	  <div class="row" id="load_more_item_section">
	     ...
	     <div class="column5" product_id="<?php echo e($product->id); ?>" data-toggle="" data-target="#productModal">
	      <div class="single_product">
		    <div class="product-image">
			  <?php if($product->product_link!=null): ?> <span class="fa fa-youtube product_link" product_link="<?php echo e($product->product_link); ?>" data-toggle="modal" data-target="#product_video" ></span><?php endif; ?>
			   <img src="<?php if($product->external_link==1): ?> <?php echo e($product->image); ?> <?php else: ?> <?php echo e(asset('public/images/product')); ?>/<?php echo e($product->image); ?> <?php endif; ?>" class="img-responsive">
				 ...
				 <h3 style="display:none" class="product-price" category="<?php echo e($product->category_id); ?>" real_price="<?php echo e($product->price); ?>"> <?php if(strpos($product->price,'.')===false): ?> <?php echo e(number_format($product->price,0,'.',',')); ?> <?php else: ?><?php echo e(rtrim(number_format($product->price,2,'.',','),".0")); ?> <?php endif; ?> $</h3>
            ...
            <div class="product-request">
				...
				//	 }
			   ?>
			   <button class="btn add_to_cart" product_id="<?php echo e($product->id); ?>"  product_qty="<?php echo e($product->storeqty); ?>">اطلب الان</button> 			
	   ...
	   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
           <div id="remove_div" class="col-12" style="margin-top:20px; text-align:center;">
		     <button name="btn_more_cate" id="btn_more_cate" data-pro="<?php echo e($getProduct_id); ?>" data-cate='<?php echo e($id); ?>' class="load_more_item_btn" start_number="<?php echo e($startFrom); ?>">مشاهدة المزيد</button>
	       </div>
