    ...
    <nav class="side-navbar" >
      <div class="side-navbar-wrapper">
       ...
       $total_Request=$total_Request->count();
            ...
            ?>
            <?php if($index_permission_active): ?>
            <li style="display:none"><a href="<?php echo e(route('transfers.index')); ?>" > <i><img src="<?php echo e(asset('public/images/icons/transferstore2.png')); ?>"></i><?php echo e(trans('file.Transfers')); ?></a>
             </li>
            <?php endif; ?>
     ...
     <?php if($index_permission_active): ?>
      ...
      <?php endif; ?>
       <?php if(Auth::user()->role_id!='12'): ?> 
         <li><a href="<?php echo e(asset('sale/items_sales')); ?>"><i><img src="<?php echo e(asset('public/images/icons/orders2.png')); ?>"></i> <?php echo e(trans('file.order_items')); ?> </a></li>
          <?php if(Auth::user()->role_id!='13'): ?> 
		 <li><a href="<?php echo e(asset('sale/group_items')); ?>"><i><img src="<?php echo e(asset('public/images/icons/orders2.png')); ?>"></i> جرد مبيعات عام </a></li>
         <li><a href="<?php echo e(asset('sale/marketer_orders')); ?>"><i><img src="<?php echo e(asset('public/images/icons/orders2.png')); ?>"></i> <?php echo e(trans('file.marketer_orders')); ?> </a></li>
         <?php endif; ?>
       <?php endif; ?>
       

      <?php if(Auth::user()->role_id=='1' || Auth::user()->role_id=='2' || Auth::user()->role_id==11  ): ?>
       <li><a href="<?php echo e(asset('order/order_archive')); ?>"><i><img src="<?php echo e(asset('public/images/icons/orders2.png')); ?>"></i> ارشيف المخازن </a></li>
        <li><a href="<?php echo e(asset('order/product_qty')); ?>"><i><img src="<?php echo e(asset('public/images/icons/orders2.png')); ?>"></i> حركة مادة </a></li> 
         <!-- tonight change -->
        <li style="display:none"><a href="<?php echo e(route('qty_adjustment.index')); ?>"><i><img src="<?php echo e(asset('public/images/icons/orders2.png')); ?>"></i> Order Insert Archive </a></li>
      ...
      <?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>
			<li style="display:none"><a href="<?php echo e(asset('offers1')); ?>"><i><img src="<?php echo e(asset('public/images/icons/send2.png')); ?>"></i> <?php echo e(trans('file.send')); ?></a></li>
			<?php endif; ?>
			
			<li style="display:none"><a href="<?php echo e(asset('requests')); ?>"><i><img src="<?php echo e(asset('public/images/icons/send2.png')); ?>"></i><?php echo e(trans('file.online')); ?> <?php echo e(trans('file.orders')); ?></a></li>
                       <li style="display:none"><a href="<?php echo e(asset('requests/rejected')); ?>"><i><img src="<?php echo e(asset('public/images/icons/send2.png')); ?>"></i><?php echo e(trans('file.rejected')); ?> <?php echo e(trans('file.orders')); ?></a></li>
            ...
            <li><a href="<?php echo e(route('quick_add_product')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/product.png')); ?>"></i><?php echo e(__('file.quick_add_product')); ?> </a></li>
            <li style="display:none"><a href="<?php echo e(asset('variation')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/product.png')); ?>"></i><?php echo e(__('file.varitions')); ?></a></li>
            <?php endif; ?>
      ...
      <li><a href="<?php echo e(asset('category.sub_category')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/category.png')); ?>"></i><?php echo e(__('file.sub_categories')); ?> </a></li>
            <?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>
			<li style="display:none"><a href="<?php echo e(asset('prices')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/prices.png')); ?>"></i><?php echo e(__('file.prices')); ?></a></li>
			<?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>
			<li style="display:none"><a href="<?php echo e(route('report.movement')); ?>"><i><img src="<?php echo e(asset('public/images/icons/productmove.png')); ?>"></i> <?php echo e(trans('file.item_movement')); ?></a></li>
			<?php endif; ?>
            ...
            <?php if($index_permission_active): ?>
			 ...
			 <li><a href="<?php echo e(route('user.profile', ['id' => Auth::id()])); ?>"><i><img src="<?php echo e(asset('public/images/icons/users.png')); ?>"></i><?php echo e(trans('file.profile')); ?></a></li>   
			 <?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>
			 <li style="display:none"><a href="<?php echo e(route('role.index')); ?>"><i><img src="<?php echo e(asset('public/images/icons/permissions.png')); ?>"></i><?php echo e(trans('file.Roles')); ?></a></li>
            <?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>			
			 <li style="display:none"><a href="<?php echo e(route('store_category.index')); ?>"><i><img src="<?php echo e(asset('public/images/icons/stores.png')); ?>"></i><?php echo e(trans('file.store_category')); ?></a></li>
       ...
       <li><a href="<?php echo e(route('store.index')); ?>"><i><img src="<?php echo e(asset('public/images/icons/stores.png')); ?>"></i><?php echo e(trans('file.Stores')); ?></a></li>
            ...
            ?>
            <?php if($index_permission_active): ?>			
			 <li style="display:none"><a href="<?php echo e(route('setting.pos')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/settings.png')); ?>"></i><?php echo e(trans('file.settings')); ?></a></li>
			<?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>			
			 <li style="display:none"><a href="<?php echo e(route('setting.general')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/settings.png')); ?>"></i> <?php echo e(trans('file.General Setting')); ?></a></li>
			...
			<li style="display:none"><a href="#company" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><?php echo e(__('file.company')); ?></a>
			...
			<li style="display:none"><a href="#country" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><?php echo e(__('file.country')); ?></a>
          ...
          <li style="display:none"><a href="<?php echo e(asset('pincode/list')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/settings.png')); ?>"></i><?php echo e(trans('file.pincode')); ?></a></li>
            ...
            <?php endif; ?>
            <li style="display:none"><a href="#adjustment" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-settings"></i><?php echo e(trans('file.Quantity')); ?> <?php echo e(trans('file.Adjustment')); ?></a>
            ...
            <?php $index_permission_active = DB::table('permissions')
                ...
                ?>
                 <?php if($index_permission_active): ?>
            <?php if(Auth::user()->role_id<=2 || Auth::user()->role_id==11): ?>    
			<li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i><?php echo e(trans('file.People')); ?> </a>
              <ul id="people" class="collapse list-unstyled " <?php if(Auth::user()->role_id==9): ?> style="display:none"  <?php endif; ?>>
			...
			<li><a href="<?php echo e(route('branch.index')); ?>" > <i class="icon-user"></i><?php echo e(trans('file.branch')); ?> </a>
            </li>
			<?php endif; ?>
		   ...
		   <li style="display:none"><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-gear-outline"></i><?php echo e(trans('file.settings')); ?></a>
              <ul id="setting" class="collapse list-unstyled ">
                ...
                <li style="display:none"><a href="<?php echo e(route('setting.general')); ?>"><?php echo e(trans('file.General Setting')); ?></a></li>
                <?php endif; ?>
                ...
                <li style="display:none"><a href="<?php echo e(route('setting.pos')); ?>">POS <?php echo e(trans('file.settings')); ?></a></li>
                <?php endif; ?>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
               ...
               <?php if($alert_product > 0 and  (Auth::user()->role_id<=2 || Auth::user()->role_id==11)): ?> 
                <li class="nav-item">
                ...
                <?php endif; ?>
                 ...
                 <?php if($all_stores > 0): ?> 
                <li class="nav-item">
                      <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="fa fa-bell"></i><span class="badge badge-danger"><?php echo e($all_stores); ?></span>
                          <span class="caret"></span>
                          <span class="sr-only">Toggle Dropdown</span>
                      </a>
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                         <?php if($all_stores>0): ?>             
                         <li class="notifications">
                            <a href="<?php echo e(asset('stores/not_sales')); ?>" class="btn btn-link"> <i class="fa fa-info-circle"></i>   <?php echo e($all_stores); ?> Stores Not sale anything</a>
                          </li>
                     <?php endif; ?> 
                      </ul>
                </li>
