					...
					<div style="display:none">
					  ...
					  <?php $__currentLoopData = $data['category']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-12 checkbox_container" >
                         ...
                         <div class="col-md-6" style="margin-top:10px; padding-right:0px">					 
						    <input type="number" name="coupon_categories_<?php echo e($category->id); ?>" class="form-control">
						 </div> 
                        </div>						 
						</div>						
					  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				     ...
				     <div class="col-md-12">
					      <label style="visibility:hidden"><?php echo e(trans('file.submit')); ?></label>
					   	 <input type="submit"  class="btn btn-primary" value="<?php echo e(trans('file.create')); ?>">
					 </div>
				  <?php echo Form::close(); ?> 
				  </div> 
                </tbody>
