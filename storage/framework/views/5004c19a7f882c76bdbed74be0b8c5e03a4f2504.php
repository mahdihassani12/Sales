    ...
    <nav class="side-navbar" >
			...
			<?php 
			  ...
			  foreach($all_products as $prod){
				  if($prod->alert_quantity> $prod->sqty){$alert_product1++;}
                            ...
                            $total_Request= DB::table('sales')->where('order_status','0')->count();
      ...
      <?php if(Auth::user()->role_id=='1' || Auth::user()->role_id=='2'): ?>
       <li><a href="<?php echo e(asset('order/order_archive')); ?>"><i><img src="<?php echo e(asset('public/images/icons/orders2.png')); ?>"></i> ارشيف المخازن </a></li>
         ...
         <!-- tonight change -->
        <li><a href="<?php echo e(route('qty_adjustment.index')); ?>"><i><img src="<?php echo e(asset('public/images/icons/orders2.png')); ?>"></i> Order Insert Archive </a></li>
...
<?php endif; ?>
            ...
            ?>
            <?php if($index_permission_active): ?>			
			 <li><a href="<?php echo e(route('store_category.index')); ?>"><i><img src="<?php echo e(asset('public/images/icons/stores.png')); ?>"></i><?php echo e(trans('file.store_category')); ?></a></li>
          ...
          <li style="display:none"><a href="<?php echo e(asset('pincode/list')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/settings.png')); ?>"></i><?php echo e(trans('file.pincode')); ?></a></li>
			...
			<li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i><?php echo e(trans('file.People')); ?> </a>
              <ul id="people" class="collapse list-unstyled " <?php if(Auth::user()->role_id==9): ?> style="display:none"  <?php endif; ?>>
                ...
                ?>
                <?php if($index_permission_active): ?>
                <li style="display:none" ><a href="<?php echo e(route('customer.index')); ?>"><?php echo e(trans('file.customer')); ?> <?php echo e(trans('file.List')); ?></a></li>
                <?php 
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li style="display:none" ><a href="<?php echo e(route('customer.create')); ?>"><?php echo e(trans('file.add')); ?> <?php echo e(trans('file.customer')); ?></a></li>
                <?php endif; ?>
                <?php endif; ?>
                <?php 
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
               ...
               <?php if($alert_product > 0 and Auth::user()->role_id<=2): ?> 
                <li class="nav-item">
