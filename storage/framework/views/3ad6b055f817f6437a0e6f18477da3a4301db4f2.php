   ...
   <div class="fronted-content">
	...
	<ul class="category-list" style='text-align:center;'>
	  <li category_id="all" class="category_item category_active">كل المنتجات</li>
		...
		?>
		<?php if($all>0  && Auth::user()->role_id ==6): ?>
	...
	<div class="form-group mobile-cartegory-list">
	 <select class="form-control mobile-cartegory">
		...
		?>    
             <?php if($all>0 and  Auth::user()->role_id ==6): ?>
	      ...
	      <div class="single_product">
		    <div class="product-image">
			   ...
			   <img src="<?php if($product->external_link==1): ?> <?php echo e($product->image); ?> <?php else: ?> <?php echo e(asset('public/images/product')); ?>/<?php echo e($product->image); ?> <?php endif; ?>" class="img-responsive">
			     ...
			     <h3 class="product-price" category="<?php echo e($product->category_id); ?>" real_price="<?php echo e($product->price); ?>" style="display:none" ><?php if(strpos($product->price,'.')===false): ?> <?php echo e(number_format($product->price,0,'.',',')); ?> <?php else: ?><?php echo e(rtrim(number_format($product->price,2,'.',','),".0")); ?> <?php endif; ?> $</h3>
				 <h4 style="display:none"><?php if(strpos($product->price,'.')===false): ?> <?php echo e(number_format($product->price,0,'.',',')); ?> <?php else: ?><?php echo e(rtrim(number_format($product->price,2,'.',','),".0")); ?> <?php endif; ?></h4> 
            ...
            <div class="product-request"> 
			   <?php 
				...
				endforeach;
			   ?>
			   <button class="btn add_to_cart" product_id="<?php echo e($product->id); ?>"  product_qty="<?php echo e($product->storeqty-$added_number); ?>">اطلب الان</button> 			
			   <p style="display:none" class="english_name"><?php echo e($product->name); ?></p>
			   <p style="" class="arabic_name"><?php echo e($product->arabic_name); ?></p>
			</div>
		  </div> 
		 </div> 
	   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
