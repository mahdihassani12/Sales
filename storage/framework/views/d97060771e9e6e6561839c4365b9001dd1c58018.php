  ...
  <div style="width:400px;margin:auto;" id="select_user_cobobox">   
   <select class="selectpicker form-control" id="user_list" name="user_list" data-live-search="true" data-live-search-style="begins" title="Select User...">
	 ...
	 <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	   <option value="<?php echo e($user->phone); ?>"><?php echo e($user->name); ?></option>
   ...
   <div class="tabs-list">
      <ul>
	     <li class="order_status" status="offer"><?php echo e(trans('file.offer')); ?></li>
	     ...
	     <li class="order_status" status="paid"><?php echo e(trans('file.paid')); ?></li>
	  </ul>
   </div>
