...
<?php if(session()->has('message')): ?>
    <?php
        if(session()->get('message') == 'Sale created successfully')
            $flag = 1;
    ?>
    <div class="alert alert-success alert-dismissible text-center" style="position:absolute;z-index:11; width:100%;"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo e(session()->get('message')); ?></div>
<?php endif; ?>
<?php if(session()->has('not_permitted')): ?>
    <div class="alert alert-danger alert-dismissible text-center" style="position:absolute;z-index:11; width:100%;"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo e(session()->get('not_permitted')); ?></div> 
<?php endif; ?>
<style>
    ...
    <div class="container-fluid" style="padding:0px;padding-left:15px;">
        <div class="row">
            <div class="col-md-5 cart_section">
                <div class="card">
                    <div class="card-body">
                        <?php echo Form::open(['url' => 'sale/storemyoffer', 'method' => 'post', 'files' => true, 'class' => 'payment-form']); ?>
                        ...
                        <div class="row"> 
                            <div class="col-md-12">
								<div class="row cart_header_details">
								  <div class="col-sm-12">
									<h1><span class="total_net"><?php echo e(trans('file.net_total')); ?></span><span class="jtotal" id="grand-total">00,00 <span class="fa fa-money" id="jcash_icon"></span></span></h1>
								  </div>
								</div>
                                <div class="row">
                                ...
                                <div class="form-group">
                                    <table class="table table-bordered table-condensed totals jmtotalst" style="text-align:center">
									   <tr>
									      ...
									      <td><strong><?php echo e(trans('file.grand total')); ?></strong></td>
									      <td><strong><?php echo e(trans('file.Shipping')); ?></strong></td>
									   </tr>
            ...
            <div class="col-md-7">
							   ...
							   ?>
								...
								<table <?php if($is_paginate=="paginate"): echo "id='product-table'"; else:   endif;?> class="table product-list <?php if($itemPerRow == "1" ): echo "row-one-item"; elseif($itemPerRow=="2"): echo "row-two-item"; elseif($itemPerRow=="6" || $itemPerRow=="8"): echo "row-six-item"; endif;?>">
								 ...
								 <thead class="d-none">
                                    ...
                                    <?php for($i=0; $i < ceil($product_number/$itemPerRow); $i++): ?>
										<div></div>
									
									<?php if($itemPerRow=="1"): ?>
										  <tr>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[0+$i*1]->name); ?>" data-product ="<?php echo e($ezpos_product_list[0+$i*1]->code . ' (' . $ezpos_product_list[0+$i*1]->name . ')'); ?>"> <div class="each_product"><img  src="<?php if($ezpos_product_list[0+$i*1]->external_link==1): ?> <?php echo e(ezpos_product_list[0+$i*1]->image); ?>  <?php else: ?><?php echo e(url('public/images/product',$ezpos_product_list[0+$i*1]->image)); ?> <?php endif; ?>" width="100%" style="height:385px !important"/>
                                                <p><?php echo e($ezpos_product_list[0+$i*1]->name); ?>  jum</p></div></td>
                                            
                                            
                                        </tr>
									<?php elseif($itemPerRow=="2"): ?>
										  <tr>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[0+$i*2]->name); ?>" data-product ="<?php echo e($ezpos_product_list[0+$i*2]->code . ' (' . $ezpos_product_list[0+$i*2]->name . ')'); ?>"> <div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[0+$i*2]->image)); ?>" width="100%" style="height:248px !important"/>
                                                <p><?php echo e($ezpos_product_list[0+$i*2]->name); ?></p></div></td>
                                            <?php if(!empty($ezpos_product_list[1+$i*2])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[1+$i*2]->name); ?>" data-product ="<?php echo e($ezpos_product_list[1+$i*2]->code . ' (' . $ezpos_product_list[1+$i*2]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[1+$i*2]->image)); ?>" width="100%" style="height:248px !important" />
                                                <p><?php echo e($ezpos_product_list[1+$i*2]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
                                        </tr>	
									<?php elseif($itemPerRow=="4"): ?>
										  <tr>
									...
									<?php elseif($itemPerRow=="6"): ?>
                                        <tr class='6-item-row'>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[0+$i*6]->name); ?>" data-product ="<?php echo e($ezpos_product_list[0+$i*6]->code . ' (' . $ezpos_product_list[0+$i*6]->name . ')'); ?>"> <div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[0+$i*6]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[0+$i*6]->name); ?></p></div></td>
                                            <?php if(!empty($ezpos_product_list[1+$i*6])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[1+$i*6]->name); ?>" data-product ="<?php echo e($ezpos_product_list[1+$i*6]->code . ' (' . $ezpos_product_list[1+$i*6]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[1+$i*6]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[1+$i*6]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
                                            <?php if(!empty($ezpos_product_list[2+$i*6])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[2+$i*6]->name); ?>" data-product ="<?php echo e($ezpos_product_list[2+$i*6]->code . ' (' . $ezpos_product_list[2+$i*6]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[2+$i*6]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[2+$i*6]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
                                            <?php if(!empty($ezpos_product_list[3+$i*6])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[3+$i*6]->name); ?>" data-product ="<?php echo e($ezpos_product_list[3+$i*6]->code . ' (' . $ezpos_product_list[3+$i*6]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[3+$i*6]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[3+$i*6]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
											<?php if(!empty($ezpos_product_list[4+$i*6])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[4+$i*6]->name); ?>" data-product ="<?php echo e($ezpos_product_list[4+$i*6]->code . ' (' . $ezpos_product_list[4+$i*6]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[4+$i*6]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[4+$i*6]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
											<?php if(!empty($ezpos_product_list[5+$i*6])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[5+$i*6]->name); ?>" data-product ="<?php echo e($ezpos_product_list[5+$i*6]->code . ' (' . $ezpos_product_list[5+$i*6]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[5+$i*6]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[5+$i*6]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
                                        </tr>
                                    <?php else: ?> 
									    <tr>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[0+$i*8]->name); ?>" data-product ="<?php echo e($ezpos_product_list[0+$i*8]->code . ' (' . $ezpos_product_list[0+$i*8]->name . ')'); ?>"> <div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[0+$i*8]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[0+$i*8]->name); ?></p></div></td>
                                            <?php if(!empty($ezpos_product_list[1+$i*8])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[1+$i*8]->name); ?>" data-product ="<?php echo e($ezpos_product_list[1+$i*8]->code . ' (' . $ezpos_product_list[1+$i*8]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[1+$i*8]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[1+$i*8]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
                                            <?php if(!empty($ezpos_product_list[2+$i*8])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[2+$i*8]->name); ?>" data-product ="<?php echo e($ezpos_product_list[2+$i*8]->code . ' (' . $ezpos_product_list[2+$i*8]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[2+$i*8]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[2+$i*8]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
                                            <?php if(!empty($ezpos_product_list[3+$i*8])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[3+$i*8]->name); ?>" data-product ="<?php echo e($ezpos_product_list[3+$i*8]->code . ' (' . $ezpos_product_list[3+$i*8]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[3+$i*8]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[3+$i*8]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
											 <?php if(!empty($ezpos_product_list[4+$i*8])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[4+$i*8]->name); ?>" data-product ="<?php echo e($ezpos_product_list[3+$i*8]->code . ' (' . $ezpos_product_list[4+$i*8]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[4+$i*8]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[4+$i*8]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
											 <?php if(!empty($ezpos_product_list[5+$i*8])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[5+$i*8]->name); ?>" data-product ="<?php echo e($ezpos_product_list[5+$i*8]->code . ' (' . $ezpos_product_list[5+$i*8]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[5+$i*8]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[5+$i*8]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
											 <?php if(!empty($ezpos_product_list[6+$i*8])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[6+$i*8]->name); ?>" data-product ="<?php echo e($ezpos_product_list[6+$i*8]->code . ' (' . $ezpos_product_list[6+$i*8]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[6+$i*8]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[6+$i*8]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
											 <?php if(!empty($ezpos_product_list[7+$i*8])): ?>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[7+$i*8]->name); ?>" data-product ="<?php echo e($ezpos_product_list[7+$i*8]->code . ' (' . $ezpos_product_list[7+$i*8]->name . ')'); ?>"><div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[7+$i*8]->image)); ?>" width="100%" />
                                                <p><?php echo e($ezpos_product_list[7+$i*8]->name); ?></p></div></td>
                                            <?php else: ?>
                                            <td></td>
                                            <?php endif; ?>
                                        </tr>	
               ...
               <div class="card category_cart" style=" width:61% !important; margin-right: -32px !important;">
			     <div class="card-body">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					          <li id="view_all_item" class="single_category"><a href="#" ><?php echo e(trans('file.view_all')); ?></a></li>
				   </ul>	
				 </div>
               </div> 			   
            ...
            <div id="addCustomer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <?php echo Form::open(['url' => 'customer/add_customer', 'method' => 'post', 'files' => true]); ?>
