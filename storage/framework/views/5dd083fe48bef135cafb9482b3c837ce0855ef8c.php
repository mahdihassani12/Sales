...
<section>
    <div class="container-fluid">
        <?php if(in_array("sales-add", $all_permission)): ?>
            <a href="<?php echo e(url('/pos')); ?>" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo e(trans('file.add')); ?> <?php echo e(trans('file.Sale')); ?></a>
        <?php endif; ?>
    </div>
    <div class="table-responsive">
        <table id="sale-table" class="table table-hover sale-list">
            ...
            <tbody>
                ...
                ?>
                <tr class="sale-link" data-sale='["<?php echo e($date); ?>", "<?php echo e($sale->reference_no); ?>", "<?php echo e($sale_status); ?>", "<?php echo e($customer->name); ?>", "<?php echo e($customer->phone_number); ?>", "<?php echo e($customer->address); ?>", "<?php echo e($customer->city); ?>", "<?php echo e($sale->id); ?>", "<?php echo e($sale->total_tax); ?>", "<?php echo e($sale->total_discount); ?>", "<?php echo e($sale->total_price); ?>", "<?php echo e($sale->order_tax); ?>", "<?php echo e($sale->order_tax_rate); ?>", "<?php echo e($sale->order_discount); ?>", "<?php echo e($sale->shipping_cost); ?>", "<?php echo e($sale->grand_total); ?>", "<?php echo e($sale->paid_amount); ?>", "<?php echo e($sale->sale_note); ?>", "<?php echo e($sale->staff_note); ?>", "<?php echo e($user->name); ?>", "<?php echo e($user->email); ?>", "<?php echo e($store->name); ?>"]'>
                    ...
                    <td>
                        ...
                        <input type="hidden" class="deposit" value="<?php echo e($customer->deposit - $customer->expense); ?>">
                    </td>
                    ...
                    <td>0.00</td>
                    <?php endif; ?>
                    <?php if($sale->grand_total - $sale->paid_amount): ?>
                    <td class="balance"><?php echo e($sale->grand_total - $sale->paid_amount); ?></td>
                    <?php else: ?>
                    <td>0.00</td>
                    <?php endif; ?>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(url('sale/'.$sale->id.'/create')); ?>" class="btn btn-link"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                    <?php endif; ?>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
                                <li><a href="<?php echo e(route('sale.invoice', ['id' => $sale->id])); ?>" class="btn btn-link"><i class="fas fa-copy"></i> <?php echo e(trans('file.Generate')); ?> <?php echo e(trans('file.Invoice')); ?></a></li>
                                <li>
                                ...
                                <li>
                                    <button type="button" class="add-delivery btn btn-link" data-id = "<?php echo e($sale->id); ?>"><i class="fa fa-truck"></i> <?php echo e(trans('file.add')); ?> <?php echo e(trans('file.Delivery')); ?></button>
                                </li>
...
<script type="text/javascript">
    ...
    function saleDetails(sale){
        ...
        var htmlfooter = '<p><strong><?php echo e(trans("file.Sale")); ?> <?php echo e(trans("file.Note")); ?>:</strong> '+sale[17]+'</p><p><strong><?php echo e(trans("file.Staff")); ?> <?php echo e(trans("file.Note")); ?>:</strong> '+sale[18]+'</p><strong><?php echo e(trans("file.Created By")); ?>:</strong><br>'+sale[19]+'<br>'+sale[20];
