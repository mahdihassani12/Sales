					   ...
					   <div class="row">
						  ...
						  <div class="col-9" style="/*padding: 0px 3px 0px 12px*/">
							...
							<div class="col-6" style="padding: 0px 3px;">
							  <h2 style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"><a href="#changeCartItem" class="editProductName" data-toggle="modal" item_id="<?php echo e($product->rowId); ?>" style="display:none">edit</a> <?php echo e($product->name); ?></h2>
								   <?php 
			$allQuantity=0;								   
                        ...
                        $allQuantity=DB::table('product_store')->where('product_id',$product->id)->where('store_id',Auth::user()->selected_store)->get()[0]->qty;
							...
							<div class="row" style="margin-top:0px">
							  <div class="">
							     ...
							     <h4 style="display:none"><span class='graytitle'>السعر</span>  &nbsp;&nbsp;&nbsp;<?php echo e($product->price); ?> </h4>
							  </div>
							  <div class="col-12">
