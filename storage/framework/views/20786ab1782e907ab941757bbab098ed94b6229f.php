                ...
                <div class="card">
                    ...
                    <div class="card-body">
                      <div class="checkbox_labels">
                    	  <label>	 
						   <?php echo e(trans('file.product')); ?> <?php echo e(trans('file.name')); ?><input type="radio" name="columnType" value="productName">	
						 </label> 
                        
                          <label>	 
						   <?php echo e(trans('file.arabic_name')); ?> <input type="radio" name="columnType" value="productArabicName">	
						 </label> 
						 
						 <label>
						   <?php echo e(trans('file.product')); ?> <?php echo e(trans('file.Code')); ?><input type="radio" name="columnType" value="productCode">	
						  </label> 
                       </div>
                       <div class="importtextarea col-md-6">
                    	  ...
                    	  <div class="input_fields_title row"> 
							  <h3 class="rowTitle col-md-4"><?php echo e(trans('file.product')); ?> <?php echo e(trans('file.name')); ?></h3>
							  <h3 class="rowTitle col-md-4"><?php echo e(trans('file.product')); ?> <?php echo e(trans('file.Code')); ?></h3>
							  <h3 class="rowTitle col-md-4"><?php echo e(trans('file.arabic_name')); ?> </h3>
							</div>
