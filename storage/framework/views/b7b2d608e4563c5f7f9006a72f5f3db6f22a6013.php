            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.edit')); ?> <?php echo e(trans('file.company')); ?></h4>
                    </div>
					<?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="card-body">
                       ...
                       <?php echo Form::open(['url' => 'company/update', 'method' => 'post', 'class' => 'form-horizontal main_form form-whitout-modal', 'id'=> 'add_passenger_form', 'enctype'=> 'multipart/form-data']); ?> 
                          <div class="row"> 
						   <div class="col-md-6">
	                            <div class="form-group">
	                                <label><strong><?php echo e(trans('file.company')); ?> <?php echo e(trans('file.name')); ?> *</strong> </label>
	                                <input type="hidden" name="com_id"  value="<?php echo e($comp->company_id); ?>">
	                                <input type="text" name="name" required class="form-control" value="<?php echo e($comp->name); ?>">
						     ...
						     <div class="col-md-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" name="address"  class="form-control" value="<?php echo e($comp->address); ?>">
							 ...
							 <div class="col-md-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" name="username" required class="form-control" value="<?php echo e($comp->username); ?>">
							...
							<div class="col-md-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" name="mail" required class="form-control" value="<?php echo e($comp->email); ?>">
							...
							<div class="col-md-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" name="phone"  class="form-control" value="<?php echo e($comp->phone); ?>">
							...
							<div class="col-md-6">
	                            <div class="form-group">
	                                <label><strong><?php echo e(trans('file.extra')); ?> 1 </strong> </label>
	                                <input type="text" name="extra1"  class="form-control" value="<?php echo e($comp->extra1); ?>">
                                    <?php if($errors->has('name')): ?>
                                    <span>
							...
							<div class="col-md-6">
	                            <div class="form-group">
	                                <label><strong><?php echo e(trans('file.extra')); ?> 2</strong> </label>
	                                <input type="text" name="extra2"  class="form-control" value="<?php echo e($comp->extra2); ?>">
							...
							<div class="col-md-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" name="extra3"  class="form-control" value="<?php echo e($comp->extra3); ?>">
