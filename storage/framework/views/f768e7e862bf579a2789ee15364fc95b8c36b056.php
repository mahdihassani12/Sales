<?php $getProduct_id=0;?>
	   ...
	   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	      <div id="remove_div" class="col-12" style="margin-top:20px; text-align:center;">
		    <button name="btn_more_cate" id="btn_more_cate" data-cate="<?php echo e($cid); ?>" data-pro="<?php echo e($getProduct_id); ?>" class="load_more_item_btn" start_number="<?php echo e($startFrom); ?>"> مشاهدة المزيد</button>
		  </div>
