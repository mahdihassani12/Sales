...
<?php if($qr_code_data==""){
   ...
   ?>
       ...
       <div class="site-logo row">
	       <div class="col-md-8"><img src="<?php echo e(asset('public/logo/iraqsoft-logo-2@2x.png')); ?>"></div>
		   <div class="col-md-2 bill_number">
		      <h1> رقم الفاتورة: <span> <?php echo e($order->id); ?><span></h1>
		       <h1>  التاريخ: <span> <?php echo explode(' ',$order->created_at)[0];?><span></h1>
		       <h1>  العملة: <span> <?php if($currency_type=="ar"){echo "دينار عراقي"; $currency_sign="د.ع";}else{echo "دولار امريكي"; $currency_sign="$";}?><span></h1>
		   </div>
		   <div class="col-md-2">
		        <div class="qr_code">
       ...
       <div class="row invoice">
	      ...
	      <div class="col-md-4  customer_details">
		   ...
		   <?php $counter=1;?>
		    <?php if(isset($data['orderItems']) and count($data['orderItems'])>0): ?>
			    ...
			    <tr>
                   ...
                   <td><b><?php echo e($items->ch_product_name); ?></b>
				        <p>
						  <?php echo e(strip_tags($items->product_details)); ?>

						</p>
				   </td> 
                   <td><b><?php echo e(number_format($items->ch_product_price,0,'.',',')); ?> <?php echo e($currency_sign); ?></b></td> 
                   <td><b><?php echo e($items->product_qty); ?></b></td> 
                   <td><b><?php echo e(number_format($items->product_qty*$items->ch_product_price,0,'.',',')); ?> <?php echo e($currency_sign); ?></b></td> 
			   </tr>
			   <?php $counter++;?>
			   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			<?php endif; ?>
	  ...
	  <?php if(isset($data['order']) and count($data['order'])>0): ?>
	   ...
	   <div class="row price_detials">
	      <div class="col-md-3 total">الاجمالي:  <?php echo e(number_format($order->subtotal,0,'.',',')); ?> <?php echo e($currency_sign); ?></div>
	      <div class="col-md-3 shipping">كلفة التوصيل: <?php echo e(number_format($order->shipping_cost,0,'.',',')); ?> <?php echo e($currency_sign); ?></div>
	      <div class="col-md-3 discount"> مجموع الخصم : <?php echo e(number_format($order->discount,0,'.',',')); ?> <?php echo e($currency_sign); ?></div>
	      <div class="col-md-3 grand_total">المبلغ النهائي: <?php echo e(number_format($order->total,0,'.',',')); ?> <?php echo e($currency_sign); ?></div>
	   </div>
	   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
	<?php endif; ?> 
  ...
  <div class="print_footer_details row">
...
.print_area:before{
	content:"";
	background-image:url("<?php echo asset('public/logo/logo_print.png')?>");
