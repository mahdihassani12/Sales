        ...
        <table id="report-table" class="table table-hover rwd-table" data-autogen-headers="true">
            ...
            <tbody>
                <?php $__currentLoopData = $ezpos_product_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <?php if($product->alert_quantity>$product->sqty): ?>
                <tr>
					...
					<td>
						<?php if($product->parentCategory!=null): ?>
						<?php echo e($product->cateName); ?>
                    ...
                    <td><?php echo e($product->storeName); ?></td>
                    <td><?php echo e(number_format((float)($product->sqty), 0, '.', '')); ?></td>
                    <td><?php echo e(number_format((float)($product->alert_quantity), 0, '.', '')); ?></td>
                </tr>
                 <?php endif; ?>
