        ...
        <table id="category-table" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th style="display: none"><?php echo e(trans('file.parent')); ?> <?php echo e(trans('file.category')); ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php if($ezpos_parent_category): ?>
                        <td style="display: none"><?php echo e($ezpos_parent_category->name); ?></td>
                    <?php else: ?>
      ...
      <div class="modal-body">
        ...
        <div class="form-group" style="display: none">
            ...
            <select name="parent_id" class="form-control selectpicker" id="parent">
                ...
                <?php $__currentLoopData = $ezpos_category_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
