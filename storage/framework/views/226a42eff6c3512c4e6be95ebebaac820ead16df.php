            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['url' => ['marketer_order/update', $ezpos_marketer_data->id], 'method' => 'post', 'files' => true]); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="date" name="date" value="<?php echo e(date('d-m-Y', strtotime($ezpos_marketer_data->created_at))); ?>" class="form-control" required />
                                        </div>
                                    </div>
									<div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.customer')); ?> <?php echo e(trans('file.name')); ?></strong></label>
                                             <h3><?php echo e($ezpos_marketer_data->customer_name); ?></h3>
										</div>
                                    </div>
                                   <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.customer')); ?> <?php echo e(trans('file.phone')); ?></strong></label>
                                             <h3><?php echo e($ezpos_marketer_data->customer_phone); ?></h3>
										</div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                	<?php $__currentLoopData = $ezpos_product_marketer_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_adjustment_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                	<tr>
                                                	<?php 
                                                	$product = DB::table('products')->find($product_adjustment_data->product_id);
                                                	?>
                                                	<td><?php echo e($product->name); ?></td>
                                                	<td><?php echo e($product->arabic_name); ?></td>
                                                	<td><?php echo e($product->code); ?></td>
													<td><input type="number" class="form-control qty" name="qty[]" value="<?php echo e($product_adjustment_data->product_qty); ?>" required></td>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="note"><?php echo e($ezpos_marketer_data->marketer_note); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
