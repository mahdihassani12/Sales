...
<section>
   ...
   <?php endif; ?>
	...
	<div class="table-responsive">
        <table class="table table-striped" id="report-table" data-autogen-headers="true"> 
            <thead>
               <tr>
                    ...
                    <th> <?php echo e(trans('file.Order')); ?> <?php echo e(trans('file.Note')); ?> </th>
		...
		<tr> 
	     ...
	     <span><?php echo e(trans('file.selected_orders')); ?></span>
		 ...
		 <button id="allItems" class="btn btn-success"><?php echo e(trans('file.execute')); ?></button>            
	  </div>
</section>
