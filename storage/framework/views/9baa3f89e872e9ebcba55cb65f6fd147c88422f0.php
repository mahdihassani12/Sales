      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center brand">
                        <a href="<?php echo e(asset('/')); ?> <?php if($reference_id !='null' and $reference_id != ''): ?><?php echo e('?ref_id='.$reference_id); ?> <?php endif; ?>"><span class="brand-big text-center"><img src="<?php echo e(asset('public/logo')); ?>/<?php echo e($siteDetail->logo); ?>"></span></a>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled"> 
               <li><a href="<?php echo e(asset('/')); ?><?php if($reference_id !='null' and $reference_id != ''): ?><?php echo e('?ref_id='.$reference_id); ?> <?php endif; ?>">الرئیسیة</a></li>
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                <div class="fronted_label">
				   ...
				   <div class="contacts">
					  ...
					  <span class="selected_lang arabic" style="display:none"><img src="<?php echo e(asset('public/images/icons/iraq.svg')); ?>"> &nbsp;  عربی </span>
					   <span class="fa fa-angle-down"> </span>
					  <span class="language_dropdwon">
				...
				<div class="mobile-collapse">
				 <div class="contacts">
				  ...
				  <span class="currency" href="#">  
					  ...
					  <span class="selected_lang arabic" style="display:none">عربی &nbsp;<img src="<?php echo e(asset('public/images/icons/iraq.svg')); ?>"></span>
					  <span class="fa fa-angle-down"> </span>
					  <span class="language_dropdwon">
					     <a href="#" class="arabic_lang">عربی &nbsp;<img src="<?php echo e(asset('public/images/icons/iraq.svg')); ?>"></a>
					     <a href="#" class="english_lang">English &nbsp;<img src="<?php echo e(asset('public/images/icons/united-states.svg')); ?>"></a>
