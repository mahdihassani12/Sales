            ...
            <div class="logo text-uppercase"><span><img src="<?php echo e(asset('public/logo/logo-home.png')); ?>" style="width:133px;"></span></div>
			  ...
			  <ul class="store_list">
			     <?php $__currentLoopData = $data['stores']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			       <li><a href="<?php echo e(asset('fronted/changes_user_default_store')); ?>/<?php echo e($st->id); ?>/<?php echo e($data['user_id']); ?>"><span class="circle"> </span> <?php echo e($st->name); ?>  </a> <img src="<?php echo e(asset('public/images/icons/shop.svg')); ?>"></li>			  
