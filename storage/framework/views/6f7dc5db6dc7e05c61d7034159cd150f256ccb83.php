      ...
      <section class="dashboard-counts ">
        <div class="container-fluid">
          <div class="row">
            <!-- Count item widget-->
            <div class="col-md-3">
              <div class="wrapper count-title" style="border-radius:13px;background:linear-gradient(to left, #15c3ae, #44cc68)">
                <div class="row">
				   <div class="col-sm-12">
            ...
            <!-- Count item widget-->
            <div class="col-md-3">
              <div class="wrapper count-title " style="border-radius:13px;background:linear-gradient(to left, #9d1cd2, #3b7ffb)">
                <div class="row">
				   <div class="col-sm-12">
				     <i class="icon ion-ios-cart"></i>
					 <span class="label">7/8</span>
            ...
            <!-- Count item widget-->
            <div class="col-md-3">
              <div class="wrapper count-title d-flex" style="border-radius:13px;background:linear-gradient(to left, #ff5479, #ff9475)">
                <div class="row">
				   <div class="col-sm-12">
				     <i class="icon ion-ios-cart"></i>
					 <span class="label">7/8</span>
            ...
            <!-- Count item widget-->
            <div class="col-md-3">
              <div class="wrapper count-title d-flex" style="background:linear-gradient(to left, #2b9cff, #01c3fe);border-radius:13px;">
                 <div class="row">
				   <div class="col-sm-12">
				     <i class="icon ion-ios-cart"></i>
					 <span class="label">7/8</span>
