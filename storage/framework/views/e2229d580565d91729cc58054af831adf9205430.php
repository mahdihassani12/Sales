...
<section class="forms">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.add')); ?> <?php echo e(trans('file.Purchase')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <?php echo Form::open(['route' => 'purchase.store', 'method' => 'post', 'files' => true, 'id' => 'purchase-form']); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Purchase')); ?> <?php echo e(trans('file.status')); ?></strong></label>
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Order')); ?> <?php echo e(trans('file.Tax')); ?></strong></label>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            ...
            <td><strong><?php echo e(trans('file.Order')); ?> <?php echo e(trans('file.Tax')); ?></strong>
                <span class="pull-right" id="order_tax">0.00</span>
            </td>
            <td><strong><?php echo e(trans('file.Order')); ?> <?php echo e(trans('file.Discount')); ?></strong>
