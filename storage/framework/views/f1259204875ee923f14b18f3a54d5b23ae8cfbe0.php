                    ...
                    <div class="card-body">
                        ...
                        <div class="row"> 
                            <div class="col-md-12">
                                ...
                                <div class="column-7">
                                    <button style="background: #47d147" type="button" class="btn btn-custom"  id="cash-btn"><i class="fa fa-money"></i> Cash</button>
                                </div>
                                <div class="column-7">
                                    <button style="background: #47d147" type="button" class="btn btn-custom"  id="cash-btn_print"> Cash & Print</button>
                                </div>
                                <div class="column-7">
            ...
            <div id="shipping-cost-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="shipping_cost" class="form-control numkey" step="any" autofocus="yes">
                            </div>
