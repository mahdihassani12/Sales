							   ...
							   ?>
								...
								<table <?php if($is_paginate=="paginate"): echo "id='product-table'"; else:   endif;?> class="table product-list <?php if($itemPerRow == "1" ): echo "row-one-item"; elseif($itemPerRow=="2"): echo "row-two-item"; elseif($itemPerRow=="6" || $itemPerRow=="8"): echo "row-six-item"; endif;?>">
								 ...
								 <thead class="d-none">
									...
									<?php if($itemPerRow=="1"): ?>
										  <tr>
                                            <td class="product-img" title="<?php echo e($ezpos_product_list[0+$i*1]->name); ?>" data-product ="<?php echo e($ezpos_product_list[0+$i*1]->code . ' (' . $ezpos_product_list[0+$i*1]->name . ')'); ?>"> <div class="each_product"><img  src="<?php echo e(url('public/images/product',$ezpos_product_list[0+$i*1]->image)); ?>" width="100%" style="height:385px !important"/>
                                                <p><?php echo e($ezpos_product_list[0+$i*1]->name); ?></p></div></td>
