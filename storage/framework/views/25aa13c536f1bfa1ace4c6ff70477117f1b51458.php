      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center">
            <a href="<?php echo e(asset('/')); ?>"><span class="brand-big text-center"><img src="<?php echo e(url('public/logo/logo-home.png')); ?>" ></span></a>
          </div>
          <!-- Small Brand information, appears on minimized sidebar-->
          <div class="sidenav-header-logo"><a href="<?php echo e(asset('/')); ?>" class="brand-small text-center"> <strong><img src="<?php echo e(url('public/logo/logo-home.png')); ?>" style="width:78px;"></strong></a><button class="close" id="hide-dashboard-in-small-size">x</button></div>
        </div>
        <!-- Sidebar Navigation Menus-->
        <div class="main-menu">
          <ul id="side-main-menu" class="side-menu list-unstyled"> 
            <li class="divider-item"><span class="section-divider"><?php echo e(trans('file.fundamentals')); ?></span></li> 		   
			<li><a href="<?php echo e(url('/')); ?>"> <i><img src="<?php echo e(asset('public/images/icons/home.png')); ?>"></i><?php echo e(__('file.dashboard')); ?></a></li>
			<?php 
            ...
            ?>
            <?php if($index_permission_active): ?>
            <li style="display:none"><a href="#expense" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-calculator"></i><?php echo e(trans('file.Expense')); ?></a>
            ...
            ?>
            <?php if($index_permission_active): ?>
            <li style="display:none"><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="ion-arrow-return-left"></i> <?php echo e(trans('file.return')); ?></a>
            ...
            <li style="display:none"><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i><?php echo e(trans('file.People')); ?></a>
