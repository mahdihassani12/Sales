                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="sale_status" value="<?php echo e($ezpos_sale_data->sale_status); ?>" />
                                            <input type="hidden" name="sale_id" value="<?php echo e($ezpos_sale_data->id); ?>" />
                                ...
                                <div class="form-group">
                                    <table class="table table-bordered table-condensed totals">
                                        <tr>
                                            ...
                                            <span class="pull-right" id="item"><?php echo e($ezpos_sale_data->item); ?>( <?php echo e($ezpos_sale_data->total_qty); ?>)</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <span class="pull-right pos-btn" id="tax"><?php echo e(number_format((float)($ezpos_sale_data->total_tax + $ezpos_sale_data->order_tax), 2, '.', '')); ?></span>
                                            </td>
                                            ...
                                            <td><strong><?php echo e(trans('file.grand total')); ?></strong>
                                                <span class="pull-right" id="grand-total"><?php echo e(number_format((float)($ezpos_sale_data->grand_total), 2, '.', '')); ?></span>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
