...
<?php endif; ?>
	 ...
	 <div class="container-fluid" >
        ...
        <div class="row store_boxes">
           <?php if($data['store_category']!="all"): ?>
          ...
          <?php $selected_store=explode("-",$st->store_category_id);?>
      <?php for($i=0;$i<count($selected_store); $i++): ?> 
      <?php if($selected_store[$i]==$data['store_category'] ): ?>     
      <div class="col-md-3"> 
            <div class="store_box">
