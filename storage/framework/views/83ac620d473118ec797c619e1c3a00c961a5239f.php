                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'user.store', 'method' => 'post', 'files' => true]); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.full_name')); ?></strong></label>
                                    ...
                                    <div class="form-group" id="store-id">
                                        ...
                                        <select id="salesman_store_id" name="store_id[]" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Store..."   multiple>
									 ...
									 <div class="form-group" id="branch-id">
                                        <label><strong><?php echo e(trans('file.branch')); ?> *</strong></label>
                                        <select id="branch_admin_id" name="branch_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Branch..."   >
                                          <?php $__currentLoopData = $ezpos_branch_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
