 ...
 <div class="card">
   ...
   <div class="card-body" style="min-height:410px;text-align:center;">
       ...
       <?php if($reference_id=="null"): ?>
		<a href="<?php echo e(asset('/fronted')); ?>" style="    font-size: 18px;font-weight: 700;margin-top: 5px;color:#7b7bdc">تسوق المزید</a>
		<?php else: ?>	
		<a href="<?php echo e(asset('/fronted')); ?>/<?php echo e($reference_id); ?>" style="    font-size: 18px;font-weight: 700;margin-top: 5px;color:#7b7bdc">تسوق المزید</a>
        <?php endif; ?>
