            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       <?php echo Form::open(['url' => 'country/store', 'method' => 'get', 'class' => 'form-horizontal main_form form-whitout-modal', 'id'=> 'add_passenger_form', 'enctype'=> 'multipart/form-data']); ?> 
                          <div class="row"> 
						   <div class="col-md-6">
							...
							<div class="col-md-6">
	                            <div class="form-group">
	                                ...
	                                <input type="text" name="shipping_sale"  class="form-control">
							...
							<div class="col-md-6">
	                            <div class="form-group">
	                                ...
	                                <select class="form-control" name="company" required>
									  ...
									  <option value="<?php echo e($comp->company_id); ?>"><?php echo e($comp->name); ?></option>
