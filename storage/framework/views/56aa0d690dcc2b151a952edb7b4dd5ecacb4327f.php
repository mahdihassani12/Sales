        ...
        <table id="product-data-table" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.shipping_cost')); ?></th>
                    <th><?php echo e(trans('file.shipping_sale')); ?></th>
            ...
            <tbody>
			   <?php if($country): ?>
                <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cuntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                
                <tr class="company-link" >
                    <td></td>
					<td><?php echo e($cuntry->country); ?></td>
                    <td><?php echo e($cuntry->cost_shiping); ?></td>
                    <td><?php echo e($cuntry->sale_shipping); ?></td>
                    <td><?php echo e($cuntry->company_id); ?></td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
								...
								<li>
                                    <a href="<?php echo e(asset('country/edit')); ?>/<?php echo e($cuntry->country_id); ?>" class="btn btn-link"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
								<li class="divider"></li>
								
								<?php echo e(Form::open(['url' => ['country/delete', $cuntry->country_id], 'method' => 'DELETE'] )); ?>
