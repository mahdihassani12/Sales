...
<div style="direction:rtl">
  <p><b><?php echo e(trans('file.date')); ?> : </b> <span><?php echo e($data['order'][0]->date); ?></span>   <button style="float:left;" class="order_print_btn btn btn-info">  <a href="<?php echo e(asset('online_order/print')); ?>/<?php echo e($data['order'][0]->request_id); ?>" style="color:#fff" target="_blank"><?php echo e(trans('file.Print')); ?></a></button></p>
