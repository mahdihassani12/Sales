...
<section>
    <div class="container-fluid" >
        ...
        <button data-target="#adjustment_modal" data-toggle="modal" class="btn btn-info" style="display:none;"><i class="fa fa-plus"></i> <?php echo e(trans('file.add')); ?> <?php echo e(trans('file.Adjustment')); ?> </button>
